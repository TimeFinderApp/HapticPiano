...
let pianoKeys: [PianoKey] = [
    ...
    PianoKey(note: "F2", frequency: 87.31, sharpness: 0.082, isSharp: false),
    PianoKey(note: "F#2", frequency: 92.50, sharpness: 0.139, isSharp: true),
    PianoKey(note: "G2", frequency: 98.00, sharpness: 0.184, isSharp: false),
    PianoKey(note: "G#2", frequency: 103.83, sharpness: 0.258, isSharp: true),
    PianoKey(note: "A2", frequency: 110.00, sharpness: 0.302, isSharp: false),
    ...
    PianoKey(note: "C3", frequency: 130.81, sharpness: 0.466, isSharp: false),
    ...
    PianoKey(note: "F3", frequency: 174.61, sharpness: 0.747, isSharp: false),
